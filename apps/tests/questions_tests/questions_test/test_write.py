...
def test_write_not_answered_should_succeed(
    client, user_with_trial_sub_token: str, write_question_data
) -> None:
...
def test_write_answered_should_succeed(
    client, write_question_data_answered: str
) -> None:
