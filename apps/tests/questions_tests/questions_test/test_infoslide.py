...
def test_infoslide_not_answered_should_succeed(
    client, user_with_trial_sub_token, info_question_data
) -> None:
...
def test_infoslide_answered_should_succeed(
    client, info_question_answered_data: str
) -> None:
