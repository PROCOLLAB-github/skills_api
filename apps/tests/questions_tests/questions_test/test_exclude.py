...
def test_exclude_not_answered_should_succeed(
    client, user_with_trial_sub_token, exclude_question_data
) -> None:
...
def test_exclude_answered_should_succeed(
    client, exclude_question_data_answered
) -> None:
